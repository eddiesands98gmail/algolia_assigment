...
const Autocomplete = (props) => {
  ...
  // Store searches in Local Storage to display in search
  const recentSearchesPlugin = createLocalStorageRecentSearchesPlugin({
    key: "RECENT_SEARCH",
    limit: 5,
  });

  // Set up autocomplete search instance
          ...
          return [
            {
              ...
              getItemUrl({ item, autocompleteState }) {
                console.log(item);
                return item.url;
              },
            },
  ...
  return (
    <div className="aa-Autocomplete" {...autocomplete.getRootProps({})}>
      ...
      <div className="aa-Panel" {...autocomplete.getPanelProps({})}>
        {(autocompleteState.isOpen == false && autocompleteState.query) ||
